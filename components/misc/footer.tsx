      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <Link href={process.env.NEXT_PUBLIC_LINK_X} className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
            ...
            <li className="ml-4">
              <Link href={process.env.NEXT_PUBLIC_LINK_DISCORD} className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Discord">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; {process.env.NEXT_PUBLIC_APP_NAME} All rights reserved. </div>
        </div>
